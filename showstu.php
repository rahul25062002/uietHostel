<?php include_once("clkheader.php"); ?>
    ...
    <tr>
      ...
      <th><img src="<?php echo $single['img'] ?>" height="50" width="50">
        <br/>(<?php echo strtoupper($single['gender']) ?>)
      ...
      <th><a href="delete_stu.php?a=<?php echo $single['id'] ?>"><img src="my/del.png" height="30" width="30"></a></th>
      <th><a href="edit_stu.php?a=<?php echo $single['id'] ?>"><img src="my/edit.png" height="30" width="30"></a></th>
    </tr>     
    <?php } } ?>
    </table>
          </div>
