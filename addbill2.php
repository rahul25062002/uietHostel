      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-5 box">
            <form action="addbill3.php" method="post" enctype="multipart/form-data">
                  <div class="row">
                  ...
                  <div class="row mb-5">
                    <div class="col-md-12 form-group">
                      <label for="name">Totel Attendence</label>
                      <input name="t2" required="required"  class="form-control" placeholder="%">
                    </div>
                  </div>

                  <div class="row mb-5">
                    <div class="col-md-12 form-group">
                      <label for="name">Mess Bill</label>
                      <input type="text" name="t3" required="required" class="form-control">
                    </div>
                  </div>
