      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-md-5 box">
            <form action="notice_code.php" method="post" enctype="multipart/form-data">
                  <div class="row">
                    ...
                    <div class="col-md-12 form-group">
                      ...
                      <input type="date" id="name" class="form-control" name="t2" required="required">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <select class="form-control" name="t3" required="required">
                        ...
                        <option value="wardan">WARDAN</option>
