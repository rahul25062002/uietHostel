<?php include_once("userheader.php"); ?>
    ...
    <?php 
    $data=mysqli_query($con,"select * from examfee where cls='$cls'")
    ...
    <tr>
      ...
      <th><?php echo $single['sem'] ?></th>
      <th><?php echo $single['fee'] ?></th>
      <th><a href="delete_exam.php?a=<?php echo $single['id'] ?>"><img src="my/del.png" height="30" width="30"></a></th>
      </tr>     
    <?php } } ?>
    </table>
          </div>
