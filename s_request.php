<?php include_once("clkheader.php"); ?>
    ...
    <tr>
      ...
      <th><a href="delete_request.php?a=<?php echo $single['id'] ?>"><img src="my/del.png" height="30" width="30"></a></th>
      <th><a href="rpy.php?a=<?php echo $single['id'] ?>"><img src="my/rpy.png" height="30" width="30"></a></th>
      </tr>     
    <?php } } ?>
    </table>
          </div>
