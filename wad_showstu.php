<?php include_once("wadheader.php"); ?>
    ...
    <tr>
      ...
      <th style="text-align: center !important;line-height: 50px !important;"><?php if($single['r_no']==""){
        echo"--------";
      }else{
        echo $single['r_no']; 
      }?></th>
      <th style="text-align: center !important;line-height: 50px !important;"><?php if($single['h_no']==""){
        echo"--------";
      }else{
        echo $single['h_no']; 
      }?></th>
