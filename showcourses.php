<?php include_once("adminheader.php"); ?>
    ...
    <?php 
    $data=mysqli_query($con,"select * from coursesfee")
    ...
    <tr>
      ...
      <th><a href="delete_courses.php?a=<?php echo $single['id'] ?>"><img src="my/del.png" height="30" width="30"></a></th>
      </tr>     
    <?php } } ?>
    </table>
          </div>
