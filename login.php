<html lang="en">
  ...
  <body>
    ...
    <section class="site-hero site-hero-innerpage overlay" data-stellar-background-ratio="0.5" style="background-image: url(my/login.jpg);min-height: 300px !important;">
      <div class="container">
            ...
            <form action="logincode.php" method="post">
                  ...
                  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <input type="password" id="name" class="form-control " name="t2" required="required">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-12 form-group">
                      ...
                      <select class="form-control" name="t3" required="required">
                        ...
                        <option value="wad">WARDAN</option>
